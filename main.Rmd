...
```{r} 
train_predict <- stats::predict(model, train_pre_processed_values)
ggplot2::qplot(x = exp(train_predict), y = exp(train_pre_processed_values$SalePrice),
...
write.csv(prediction.table, paste0('svmLinear2_1', "_predictions", ".csv"), row.names = F)
```
