...
De forma exploratoria, se procede a relizar una sencilla regresión linear y analizar la uniformación desprendida de su resultado.
...
write.csv(prediction.table, "prediction2.csv", row.names = FALSE)
